            ...
            <div class="row d-flex align-items-center">
                <div class="col-7">
                    ...
                    <?php else: ?>
                        <div class="logo logo-theme">
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
                                <img src="<?php echo esc_url( get_template_directory_uri().'/images/logo-DACPHATLAND-03.png'); ?>" alt="<?php bloginfo( 'name' ); ?>">
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
                <div class="col-5 d-flex align-items-center justify-content-end">
                        ...
                        <?php if ( nerf_get_config('header_mobile_menu', true) ) { ?>
                            <a href="#" class="btn-showmenu d-inline-flex align-items-center">
